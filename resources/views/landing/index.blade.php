            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-6 space-y-6">
                    <p class="text-base leading-relaxed text-gray-500 ">
                        Jika lupa password silahkan hubungi administrator
                    </p>
                </div>
                <!-- Modal footer -->
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b">
                    <button data-modal-hide="defaultModal" type="button"
                        class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">I
                        Kembali</button>
                </div>
            </div>
        </div>
